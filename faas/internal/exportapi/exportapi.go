...
// 本路由无 JSON body，勿接 readBody（MaxBodyBytes 仅约束该读法）。
package exportapi
...
const selectCols = `id, happened_at, value_number, value_text, tags, objective_context, subjective_interpretation`
